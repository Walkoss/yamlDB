...
TokenHash tokens[] = {
        ...
        {.token = T_OP_ASTERISK, .value = "operator-asterisk"},
        {.token = T_OP_DOT, .value = "operator-dot"},
        {.token = T_KW_CREATE, .value = "create"},
        {.token = T_KW_DROP, .value = "drop"},
        {.token = T_KW_USE, .value = "use"},
        {.token = T_KW_SELECT, .value = "select"},
        {.token = T_KW_LEFT, .value = "left"},
        {.token = T_KW_JOIN, .value = "join"},
        {.token = T_KW_ON, .value = "on"},
