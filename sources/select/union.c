...
int openFilesForInnerJoin(Database *database, Table *table1, Table *table2, char *key, char *key2, void *field, void *condition) {
    FILE *file;
    FILE *file2;
    char *path;
    char *path2;
...
long displaySecondFile(FILE *file2, char *key2) {
    ...
    while (fgets(currentLine, BUFFER_SIZE, file2) != NULL) {
        ...
        if (strcmp(keyFile, key2) != 0 && strcmp(keyFile, "-\n") != 0) {
